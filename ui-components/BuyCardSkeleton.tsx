...
interface BuyCardSkeletonProps {
  isLarge?: boolean;
}

const BuyCardSkeleton: FC<BuyCardSkeletonProps> = ({ isLarge = false }) => {
  return (
    <div className="bg-white rounded-xl overflow-hidden flex flex-col h-full p-4 animate-pulse">
      {/* Image skeleton */}
      ...
      <div className="flex flex-col flex-grow">
        ...
        {/* Title skeleton */}
        <div className={`mb-2 ${isLarge ? 'lg:text-lg' : ''}`}>
...
export default BuyCardSkeleton;
