...
export const ApplicationForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await submitLead({
      lead: {
        service_type: 'Дизайнерские услуги',
        name: formData.name.trim(),
        phone: formData.phone.trim(),
        email: formData.email.trim() || undefined,
        source: 'web-design-form',
    ...
    <div className="bg-gradient-to-br overflow-hidden relative z-10 from-[#0036A5] to-[#115DFB] rounded-3xl">
      <div className="flex flex-col lg:flex-row lg:justify-center lg:gap-52">
        ...
        <div className="text-white lg:hidden px-6 py-8">
          <h2 className="text-2xl font-bold mb-4">Заказать дизайн проект</h2>
          <p className="text-lg text-[#BBD2FF] leading-relaxed">
            Закажите индивидуальный дизайн-проект, созданный с учётом ваших
            пожеланий, стиля жизни и бюджета. Мы разработаем функциональное и
            эстетичное пространство, в котором будет приятно жить, работать и
            отдыхать.
          </p>
        </div>
        ...
        <div className="hidden lg:block text-white w-full lg:w-[70%] py-8 px-6 lg:py-[60px] lg:px-20">
          ...
          <p className="text-lg lg:text-[20px] text-[#BBD2FF] leading-6 lg:leading-[24px]">
            Закажите индивидуальный дизайн-проект, созданный с учётом ваших
            пожеланий, стиля жизни и бюджета. Мы разработаем функциональное и
            эстетичное пространство, в котором будет приятно жить, работать и
            отдыхать. От идеи до реализации - всё под ключ с профессиональным
            подходом и вниманием к деталям.
          </p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-3 bg-gray-100 border-0 rounded-lg focus:ring-2 focus:ring-blue-500 focus:bg-white outline-all transition-all"
                />
              </div>
            </div>
