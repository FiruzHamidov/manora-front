...
import { residentialSitemapIndex, sitemapResponse } from '@/services/new-buildings/sitemap';
...
export function GET() {
  const generate = () => sitemapResponse(() => residentialSitemapIndex(API_BASE_URL), RESIDENTIAL_V2_ENABLED);
