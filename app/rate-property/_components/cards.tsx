...
const cardsData = [
  {
    ...
    description: 'Жилых помещений',
  },
  {
    image: '/images/extra-pages/document.png',
    description: 'Торговой недвижимости',
  },
  {
    image: '/images/extra-pages/gold-money.png',
    description: 'Административных и офисных площадей',
  },
  {
    image: '/images/extra-pages/home-search.png',
    description: 'Нежилых помещений широкого профиля',
  },
];
