...
export const BuildingInfo: FC<BuildingInfoProps> = ({
  building,
  photos,
  stats,
  showHero = true,
  ...
  useEffect(() => {
    if (!showHero || !canSwitchImages) return;
  ...
  }, [canSwitchImages, displayImages.length, showHero]);
  ...
  return (
    <div className="space-y-5">
          ...
          {canSwitchImages ? (
            <>
              <button
                ...
                className="absolute left-4 top-1/2 z-10 inline-flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-white/20 bg-black/35 text-white backdrop-blur-md transition hover:bg-black/65 sm:left-6 lg:left-8"
              ...
              <button
                ...
                className="absolute right-4 top-1/2 z-10 inline-flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-white/20 bg-black/35 text-white backdrop-blur-md transition hover:bg-black/65 sm:right-6 lg:right-8"
      ...
      {showHero && displayImages.length > 1 ? (
        <section className="w-full bg-white py-4 shadow-[0_2px_20px_rgba(15,23,42,0.05)]">
      ...
      {showDetails && building.features && building.features.length > 0 ? (
        <section className="rounded-[26px] bg-white p-4 shadow-[0_2px_20px_rgba(15,23,42,0.05)] md:p-6">
      ...
      {showDetails && building.description ? (
        <section className="rounded-[26px] bg-white p-4 shadow-[0_2px_20px_rgba(15,23,42,0.05)] md:p-6">
