...
import {
  orderHomeLocationOptions,
  orderListingLocationOptions,
} from '../services/home/location-options.ts';
...
test('listing form prioritizes five requested cities then sorts all remaining cities', () => {
  const result = orderListingLocationOptions([
    { id: 9, name: 'Яван' },
    { id: 6, name: 'Рудаки' },
    { id: 8, name: 'Исфара' },
    { id: 2, name: 'Худжанд' },
